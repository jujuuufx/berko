...
function External:Window(properties)
    ...
    External.Gui = External:Create("ScreenGui", { Parent = CoreGui, Name = "StackzGUI", Enabled = true, IgnoreGuiInset = true, ZIndexBehavior = Enum.ZIndexBehavior.Sibling })
    External.Other = External:Create("ScreenGui", { Parent = CoreGui, Name = "StackzOther", Enabled = false, IgnoreGuiInset = true })
    ...
    if InputService.TouchEnabled then
        External.ToggleGui = External:Create("ScreenGui", { Parent = CoreGui, Name = "StackzToggle", IgnoreGuiInset = true })
